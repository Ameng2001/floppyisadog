...
function fetchEmployees(companyUuid) {
  return (dispatch, getState) => {
    ...
    const directoryPath = '/json/companie/Directory';
...
function fetchEmployee(companyUuid, employeeUuid) {
  return (dispatch, getState) => {
    ...
    const directoryPath =
      '/json/company/GetDirectoryEntry';
    ...
    return fetch(
      ...
      .then(checkCode)
      .then((data) => {
        const normalized = normalize(data.rsp, employeesSchema);
...
export function createEmployee(companyUuid, employeeData, callback) {
  return (dispatch, getState) => {
    ...
    const directoryPath = '/json/company/CreateDirectory';
      ...
      routeToMicroservice('company', directoryPath),
      {
        ...
        body: JSON.stringify({
          req: {
            ...
            internal_id: employeeData.internal_id
          }
        }),
      })
      .then(checkStatus)
...
export function updateEmployee(companyUuid, employeeUuid, newData, callback) {
  return (dispatch, getState) => {
    ...
    const directoryPath = '/json/company/UpdateDirectoryEntry';
    ...
    return fetch(
      ...
      .then(data => {
        ...
        if (callback) {
          callback.call(null, data.rsp, null);
        }
