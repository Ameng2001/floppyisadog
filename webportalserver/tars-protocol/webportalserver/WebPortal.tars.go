// Package webportalserver comment
// This file was generated by tars2go 1.1.10
// Generated from WebPortal.tars
package webportalserver
...
func (obj *WebPortal) Add(a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *WebPortal) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *WebPortal) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *WebPortal) Sub(a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *WebPortal) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *WebPortal) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *WebPortal) SetServant(servant m.Servant) {
	obj.servant = servant
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (obj *WebPortal) TarsSetTimeout(timeout int) {
	obj.servant.TarsSetTimeout(timeout)
}

// TarsSetProtocol sets the protocol for the servant.
func (obj *WebPortal) TarsSetProtocol(p m.Protocol) {
	obj.servant.TarsSetProtocol(p)
}

// AddServant adds servant  for the service.
func (obj *WebPortal) AddServant(imp WebPortalServant, servantObj string) {
	tars.AddServant(obj, imp, servantObj)
}

// AddServantWithContext adds servant  for the service with context.
func (obj *WebPortal) AddServantWithContext(imp WebPortalServantWithContext, servantObj string) {
	tars.AddServantWithContext(obj, imp, servantObj)
}

type WebPortalServant interface {
	Add(a int32, b int32, c *int32) (ret int32, err error)
	Sub(a int32, b int32, c *int32) (ret int32, err error)
}
type WebPortalServantWithContext interface {
...
func (obj *WebPortal) Dispatch(tarsCtx context.Context, val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, withContext bool) (err error) {
	var (
		length int32
		have   bool
		ty     byte
	...
	case "Add":
		...
		var funRet int32
		if !withContext {
			imp := val.(WebPortalServant)
			funRet, err = imp.Add(a, b, &c)
		} else {
			imp := val.(WebPortalServantWithContext)
