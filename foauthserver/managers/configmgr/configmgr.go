...
func InitConfig(configFile string) {
	if configFile != "" {
		...
		ConfigInstance.Oauth.AccessTokenLifetime = utils.StringToInt(oauthcfg["AccessTokenLifetime"])
		ConfigInstance.Oauth.RefreshTokenLifetime = utils.StringToInt(oauthcfg["RefreshTokenLifetime"])
		ConfigInstance.Oauth.AuthCodeLifetime = utils.StringToInt(oauthcfg["AuthCodeLifetime"])
		...
		ConfigInstance.Session.MaxAge = utils.StringToInt(sessionCfg["MaxAge"])
		ConfigInstance.Session.HTTPOnly = utils.StringToBool(sessionCfg["HTTPOnly"])
