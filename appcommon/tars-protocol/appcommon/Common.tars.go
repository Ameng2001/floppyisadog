...
func (obj *Common) Add(a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *Common) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *Common) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *Common) Sub(a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *Common) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *Common) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *Common) SetServant(servant m.Servant) {
	obj.servant = servant
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (obj *Common) TarsSetTimeout(timeout int) {
	obj.servant.TarsSetTimeout(timeout)
}

// TarsSetProtocol sets the protocol for the servant.
func (obj *Common) TarsSetProtocol(p m.Protocol) {
	obj.servant.TarsSetProtocol(p)
}

// AddServant adds servant  for the service.
func (obj *Common) AddServant(imp CommonServant, servantObj string) {
	tars.AddServant(obj, imp, servantObj)
}

// AddServantWithContext adds servant  for the service with context.
func (obj *Common) AddServantWithContext(imp CommonServantWithContext, servantObj string) {
	tars.AddServantWithContext(obj, imp, servantObj)
}

type CommonServant interface {
	Add(a int32, b int32, c *int32) (ret int32, err error)
	Sub(a int32, b int32, c *int32) (ret int32, err error)
}
type CommonServantWithContext interface {
...
func (obj *Common) Dispatch(tarsCtx context.Context, val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, withContext bool) (err error) {
	var (
		length int32
		have   bool
		ty     byte
	...
	case "Add":
		...
		var funRet int32
		if !withContext {
			imp := val.(CommonServant)
			funRet, err = imp.Add(a, b, &c)
		} else {
			imp := val.(CommonServantWithContext)
